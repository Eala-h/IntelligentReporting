# Retriever Ablation: w/o exact matching 
# All other parts (including: descriptions, stemmed descriptions and empty tables filtering) are retained
...
result_log.append({'Result of': f'Version w/o table-name exact match on {work_set} with top_k = {k} cap',
