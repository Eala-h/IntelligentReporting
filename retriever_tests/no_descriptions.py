# Retriever Ablation: w/o descriptions (and stemmed descriptions)
# Other parts (including: empty table filtering and exact matching) are retained
...
index = faiss.read_index('faiss_index/no_desc_index_whole_schema.faiss')
...
result_log.append({'Result of': f'Version w/o descriptions (+ exact match) on {work_set} with top_k = {k} cap',
