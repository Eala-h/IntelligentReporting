# Retriever Ablation: w/o stemmed descriptions
# All other parts (including: descriptions, empty table filtering and exact matching) are retained
...
index = faiss.read_index('faiss_index/whole_schema_unstemmed.faiss')
...
result_log.append({'Result of': f'Version w/o stemmed descriptions (+ exact match) on {work_set} with top_k = {k} cap',
