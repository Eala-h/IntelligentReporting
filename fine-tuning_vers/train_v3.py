# Version 3: All 4 modules (r = 16, alpha = 32 .. different from v1 & v2)
import torch
...
OUTPUT_DIR = './models/fine_tuned_v3' 
...
lora_config = LoraConfig(
    r = 16, # Changed from v1&2
    lora_alpha = 32, #Changed from v1&2
    target_modules = ['q_proj', 'v_proj', 'k_proj', 'o_proj'], #Same as v2
    lora_dropout = 0.05,
    bias = 'none',
    task_type = "CAUSAL_LM"
)
