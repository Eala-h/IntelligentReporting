# Version 4: All 4 modules (r = 16, alpha = 32 .. same as v3) change == learning rate (was = 2e-4) now = 1e-4
import torch
...
OUTPUT_DIR = './models/fine_tuned_v4' 
...
training_args = SFTConfig(
    ...
    learning_rate = 1e-4, # Changed from v3
    bf16 = True,
    logging_steps = 10,
    eval_strategy = "epoch",
    save_strategy= "epoch",
